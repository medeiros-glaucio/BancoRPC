...
public class AppClienteBanco {
    ...
    public static void main(String[] args) throws RemoteException, NotBoundException, MalformedURLException {
        ...
        // apenas a interface
        Registry registry = LocateRegistry.getRegistry("192.168.0.13", 1099);
        ...
        while(opcao != 9) {
            switch (opcao) {
                ...
                case 3: {
                    ...
                    banco.adicionarConta(saldoConta);
                    System.out.println("Conta cadastrada!");
                    try {
                        TimeUnit.SECONDS.sleep(2); // Pausa por 2 segundos
    ...
    public static void menu() {
        System.out.println("Gláucio Alves Medeiros");
        System.out.println("\n=== BANCO RMI (ou FMI?!) ===");
